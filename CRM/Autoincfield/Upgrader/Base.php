 ...
 */
class CRM_Autoincfield_Upgrader_Base {

  /**
   * @var CRM_Autoincfield_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Autoincfield_Upgrader(
        'com.joineryhq.autoincfield',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Autoincfield_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Autoincfield_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
